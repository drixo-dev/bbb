    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-24 pb-16 px-4 overflow-hidden royal-damask-bg">
      ...
      <div className="relative z-20 max-w-4xl w-full mx-auto text-center px-4">
        ...
        >
          ...
          <h1 className="font-cinzel text-4xl sm:text-6xl md:text-7xl font-extrabold text-gold-gradient tracking-wider leading-tight mb-1 uppercase drop-shadow-xl">
            BAND BAAJA<br />
            <span className="text-gold-bright">BAARAT</span>
          </h1>
          <p className="font-marcellus text-sm sm:text-lg text-gold-champagne tracking-[0.2em] uppercase mb-4">
            By Taranova Pizza
          </p>
